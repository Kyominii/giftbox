...
class VuePanier
{
                                        ...
                                        <form id=\"infos_client\" class=\"ui form\" action=\"/post/checkout/step1\" method=\"post\">
                                          ...
                                          <div class=\"field\">
                                            ...
                                            <div class=\"two fields\">
                                              <div class=\"field\">
                                                <input name=\"client_prenom\" placeholder=\"Jean\" type=\"text\">
                                              </div>
                                              <div class=\"field\">
                                                <input name=\"client_nom\" placeholder=\"Dujardin\" type=\"text\">
                                              </div>
                                            </div>
                                          </div>
                                          <div class=\"field\">
                                            ...
                                            <div class=\"fields\">
                                              <div class=\"four wide field\">
                                                <input name=\"client_numero_rue\" placeholder=\"18\" type=\"text\">
                                              </div>
                                              <div class=\"twelve wide field\">
                                                <input name=\"client_rue\" placeholder=\"Rue du Verger\" type=\"text\">
                                              </div>
                                            </div>
                                          </div>
                                          <div class=\"field\">
                                            ...
                                            <div class=\"fields\">
                                              <div class=\"twelve wide field\">
                                                <input name=\"client_ville\" placeholder=\"Laxou\" type=\"text\">
                                              </div>
                                              <div class=\"four wide field\">
                                                <input name=\"client_codePostal\" placeholder=\"54520\" type=\"text\">
                                              </div>
                                            </div>
                                          </div>
                                          <div class=\"one field\">
    ...
    public function htmlSummary(){
        ...
        $html = $html . "<div class=\"ui bulleted list\">
              ...
              <form id=\"infosFormulaire\" method=\"post\" action=\"/post/checkout/step2\">
                ...
                <input id=\"input_sauvegarder_coffret\" type=\"hidden\" name=\"sauvegarder_coffret\" value=\"\" />
              ...
              <div class=\"ui modal\">
                  ...
                  <div class=\"content\">
                    <div class=\"description\">
                      <div class=\"ui header\">Vous devez choisir un mot de passe pour pouvoir ré-utiliser ce panier ultérieurement.</div>
                      <form id=\"input_password_user\" class=\"ui form\">
                        <div class=\"field\">
                  ...
                  <div class=\"actions\">
                    ...
                    <div id=\"sendSaveBasket\" class=\"ui positive right labeled icon button\">
                      Confirmer
                      <i class=\"checkmark icon\"></i>
                    </div>
                  </div>
              ...
              <script>
                            ...
                            rules: [
                              {
                                ...
                                prompt : 'Veuillez vérifier que vous avez le tapé le même mot de passe dans les deux champs'
                              }
                            ]
                          }
                        }
                   ...
                   $(document).ready(function(){
                      ...
                      $('.ui.modal').modal('setting', 'onApprove', function(){
                            return false;
                      });

                      $(\"#sendSaveBasket\").click(function ()
                      {
                        var valide = $('#input_password_user').form('validate form');
                        $('#input_mdp_coffret').val($('#input_password_user').form('get value', 'passwordOne'));
    ...
    public function htmlCredentialBasket(){
        ...
        if(is_string($this->pbc) && $this->pbc != ""){
            $input = "<form class=\"ui form\" method=\"post\" action=\"/panier/charger/$this->pbc\">
                       <div class=\"field\">
                        <label>ID du panier</label>
                        <input disabled type='text' value='$this->pbc' />
                       </div>";
        } else {
            $input = "<form class=\"ui form\" method=\"post\" action=\"/panier/charger\"> 
                       <div class=\"field\">
                        <label>ID du panier</label>
        ...
        $html = $input .
                    "<div class=\"field\">
                        <label>Mot de passe</label>
                        <input name=\"motdepasse\" type='password' placeholder=\"Aucun si vous n'en avez pas défini\" />
                    </div>
